const quizData = [
    ...
    {
        id: 2,
        question: "Đói ăn rau, đau uống thuốc”, câu này mang ý nghĩa gì?",
        options: [
            { id: 1, text: "Sống giản dị, tuỳ hoàn cảnh", isCorrect: false },
            { id: 2, text: "Biết cách sống phù hợp, tiết kiệm", isCorrect: false },
            { id: 3, text: "Gợi nhắc sống điều độ, đúng lúc", isCorrect: false },
